...
## Next Codex Task
Add recommendation history retrieval and surface recent generated recommendations in the frontend/admin UI.
...
- Recommendation history is persisted but not yet exposed in the UI
